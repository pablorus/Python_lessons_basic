...
# Такие методы вызываются автоматически, кода объект участвует в соответствующей операции
...
class Vector:
    ...
    # Формируем удобное отображение объекта при выводе функцие print()
    def __str__(self):
...
# Наши объекты участвуют в операции сложение (+)
v3 = v1 + v2
