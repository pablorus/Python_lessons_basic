...
def test(str1, str2):  # Объявления функции (в скобочках параметры функции)
    """
    Возвращает сумму аргументов
    """
    return "{}/{}".format(str1, str2)  # Возвращаемое значение
    # Если фнкция ничего не возвращает, она возвращает спец.тип None


result = test('Hello', 'Ivan')
# test("Hello") <-- ошибка, т.к. ожидается два аргумента, передан один
print(result)
