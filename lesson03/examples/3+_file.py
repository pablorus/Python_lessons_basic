...
path = os.path.join('files', 'text.txt')  # хороший кросплатформенный метод указани пути
...
# По окончанию инструкции with файл гарантировано будет закрыт, даже если произойдет ошибка
