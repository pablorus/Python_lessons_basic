...
# Она доступна без math. ,а напрямую
print(sqrt(4))
...
print(cos(0.4))  # несовсем понятно из какого модуля данная функция, особенно если подключено много модулей
...
# 1. Повторного использования програмного кода
# 2. Разделения пространств имен (см. пример выше)
# 3. Реализация служб или данных для совместного использвания
