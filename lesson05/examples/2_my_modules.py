...
# В Python модуле - это просто питоновский(.py) файл
...
# Импорт запускает импортируемы файл - выполняя весь код в нем:
...
# доступны не тольлько функции и классы, но и все переменные импортированного модуля
