...
# Классы содеражат атрибуты - данные, и методы - функции для обработки данных
class Student:
...
# Выводим текущий класс второго ученика. Классы имеют обзую структуру и методы, но различные данные
print(student1.class_room)
...
# Любой ООП язык должен следовать слеющим парадигмам:
# 1. Инкапсуляция
# 2. Полиморфизм
# 3. Наследование
